                            ...
                            <form action="updatedata.php?id=<?php echo $Id; ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="email" name="Email" id="Email" class="form-control" placeholder="vian@gmail.com" required>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="">Phone Number</label>
                                        <input type="number" name="nilai" id="phone" class="form-control" required>
                                    </div>
